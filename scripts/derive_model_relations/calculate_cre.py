...
(
    cre_binned["connected"],
    cre_interpolated["connected"],
    cre_interpolated_average["connected"],
    cre_std_average["connected"],
) = bin_and_average_cre(
...
(
    cre_binned["no_lc"],
    cre_interpolated["no_lc"],
    cre_interpolated_average["no_lc"],
    cre_std_average["no_lc"],
) = bin_and_average_cre(
...
cre_std_average_xr = xr.Dataset()
cre_std_average_xr["connected_net"] = xr.DataArray(
    data=cre_std_average["connected"]["net"], coords={"IWP": IWP_points}
)
cre_std_average_xr["connected_sw"] = xr.DataArray(
    data=cre_std_average["connected"]["sw"], coords={"IWP": IWP_points}
)
cre_std_average_xr["connected_lw"] = xr.DataArray(
    data=cre_std_average["connected"]["lw"], coords={"IWP": IWP_points}
)
cre_std_average_xr["no_lc_net"] = xr.DataArray(
    data=cre_std_average["no_lc"]["net"], coords={"IWP": IWP_points}
)
cre_std_average_xr["no_lc_sw"] = xr.DataArray(
    data=cre_std_average["no_lc"]["sw"], coords={"IWP": IWP_points}
)
cre_std_average_xr["no_lc_lw"] = xr.DataArray(
    data=cre_std_average["no_lc"]["lw"], coords={"IWP": IWP_points}
)
cre_std_average_xr["ice_over_lc_net"] = xr.DataArray(
    data=cre_std_average["ice_over_lc"]["net"], coords={"IWP": IWP_points}
)
cre_std_average_xr["ice_over_lc_sw"] = xr.DataArray(
    data=cre_std_average["ice_over_lc"]["sw"], coords={"IWP": IWP_points}
)
cre_std_average_xr["ice_over_lc_lw"] = xr.DataArray(
    data=cre_std_average["ice_over_lc"]["lw"], coords={"IWP": IWP_points}
)
cre_std_average_xr = cre_std_average_xr.assign_coords({"IWP_bins": IWP_bins})
...
os.remove(path + "cre_std.nc")
cre_std_average_xr.to_netcdf(path + "cre_std.nc")
